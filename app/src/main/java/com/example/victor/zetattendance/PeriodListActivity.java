 ...
 * lead to a {@link PeriodDetailActivity} representing
 * item details. On tablets, the activity presents the list of items and
 * item details side-by-side using two vertical panes.
 * <p>
 * The activity makes heavy use of fragments. The list of items is a
 * {@link PeriodListFragment} and the item details
 * (if present) is a {@link PeriodDetailFragment}.
 * <p>
 * This activity also implements the required
 * {@link PeriodListFragment.Callbacks} interface
 * to listen for item selections.
 */
public class PeriodListActivity extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (findViewById(R.id.period_detail_container) != null) {
            ...
            ((PeriodListFragment) getFragmentManager()
    ...
    public void onItemSelected(String id) {
        if (mTwoPane) {
            ...
            arguments.putString(PeriodDetailFragment.ARG_ITEM_ID, id);
            ...
            detailIntent.putExtra(PeriodDetailFragment.ARG_ITEM_ID, id);
